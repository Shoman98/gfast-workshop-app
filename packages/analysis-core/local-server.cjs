...
const PARTS_DATABASE = {
  hood: { price: 0, nameEn: 'hood', nameAr: 'كبوت', partId: 'PT_0001', category: 'panels', isSafety: false },
  front_windshield: { price: 0, nameEn: 'front windshield', nameAr: 'زجاج أمامي', partId: 'PT_0002', category: 'glass', isSafety: false },
  front_wipers: { price: 0, nameEn: 'front wipers', nameAr: 'مسّاحات أمامي', partId: 'PT_0003', category: 'exterior', isSafety: false },
  a_pillars: { price: 0, nameEn: 'A pillars', nameAr: '(قائم أمامي)', partId: 'PT_0004', category: 'chassis_structure', isSafety: false },
  roof: { price: 0, nameEn: 'roof', nameAr: 'سقف', partId: 'PT_0005', category: 'panels', isSafety: false },
  grille: { price: 0, nameEn: 'grille', nameAr: 'شبكة أمامية', partId: 'PT_0006', category: 'exterior', isSafety: false },
  front_right_headlight: { price: 0, nameEn: 'front right headlight', nameAr: 'فانوس أمامي يمين', partId: 'PT_0007', category: 'exterior', isSafety: false },
  front_left_headlight: { price: 0, nameEn: 'front left headlight', nameAr: 'فانوس أمامي شمال', partId: 'PT_0008', category: 'exterior', isSafety: false },
  upper_bumper: { price: 0, nameEn: 'upper bumper', nameAr: 'اكصدام أمامي علوي', partId: 'PT_0009', category: 'panels', isSafety: false },
  front_car_logo: { price: 0, nameEn: 'front car logo', nameAr: 'شعار العربية (امامي)', partId: 'PT_0010', category: 'exterior', isSafety: false },
  trim_nickel_grille: { price: 0, nameEn: 'trim nickel grille', nameAr: 'كروم/حلية الشبكة', partId: 'PT_0011', category: 'exterior', isSafety: false },
  lower_grille: { price: 0, nameEn: 'lower grille', nameAr: 'شبكة سفلية', partId: 'PT_0012', category: 'exterior', isSafety: false },
  front_right_foglight: { price: 0, nameEn: 'front right foglight', nameAr: 'كشاف ضباب يمين', partId: 'PT_0013', category: 'exterior', isSafety: false },
  front_left_foglight: { price: 0, nameEn: 'front left foglight', nameAr: 'كشاف ضباب شمال', partId: 'PT_0014', category: 'exterior', isSafety: false },
  lower_bumper: { price: 0, nameEn: 'lower bumper', nameAr: 'اكصدام أمامي سفلي', partId: 'PT_0015', category: 'panels', isSafety: false },
  front_left_fog_trim: { price: 0, nameEn: 'front left fog trim', nameAr: 'إطار/تريم كشاف الضباب شمال', partId: 'PT_0016', category: 'exterior', isSafety: false },
  front_right_fog_trim: { price: 0, nameEn: 'front right fog trim', nameAr: 'إطار/تريم كشاف الضباب يمين', partId: 'PT_0017', category: 'exterior', isSafety: false },
  front_left_fender: { price: 0, nameEn: 'front left fender', nameAr: 'رفرف أمامي شمال', partId: 'PT_0018', category: 'panels', isSafety: false },
  left_rocker_panel: { price: 0, nameEn: 'left rocker panel', nameAr: 'عتبة جنب شمال', partId: 'PT_0019', category: 'panels', isSafety: false },
  front_left_door: { price: 0, nameEn: 'front left door', nameAr: 'باب أمامي شمال', partId: 'PT_0020', category: 'panels', isSafety: false },
  rear_left_door: { price: 0, nameEn: 'rear left door', nameAr: 'باب خلفي شمال', partId: 'PT_0021', category: 'panels', isSafety: false },
  left_quarter_panel: { price: 0, nameEn: 'left quarter panel', nameAr: 'رفرف خلفي شمال', partId: 'PT_0022', category: 'panels', isSafety: false },
  left_mirror: { price: 0, nameEn: 'left mirror', nameAr: 'مراية شمال', partId: 'PT_0023', category: 'exterior', isSafety: false },
  front_left_door_window: { price: 0, nameEn: 'front left door window', nameAr: 'زجاج باب أمامي شمال', partId: 'PT_0024', category: 'glass', isSafety: false },
  rear_left_door_window: { price: 0, nameEn: 'rear left door window', nameAr: 'زجاج باب خلفي شمال', partId: 'PT_0025', category: 'glass', isSafety: false },
  front_left_door_handle: { price: 0, nameEn: 'front left door handle', nameAr: 'أوكره/مقبض باب أمامي شمال', partId: 'PT_0026', category: 'exterior', isSafety: false },
  rear_left_door_handle: { price: 0, nameEn: 'rear left door handle', nameAr: 'أوكره/مقبض باب خلفي شمال', partId: 'PT_0027', category: 'exterior', isSafety: false },
  front_right_fender: { price: 0, nameEn: 'front right fender', nameAr: 'رفرف أمامي يمين', partId: 'PT_0028', category: 'panels', isSafety: false },
  right_rocker_panel: { price: 0, nameEn: 'right rocker panel', nameAr: 'عتبة جنب يمين', partId: 'PT_0029', category: 'panels', isSafety: false },
  front_right_door: { price: 0, nameEn: 'front right door', nameAr: 'باب أمامي يمين', partId: 'PT_0030', category: 'panels', isSafety: false },
  rear_right_door: { price: 0, nameEn: 'rear right door', nameAr: 'باب خلفي يمين', partId: 'PT_0031', category: 'panels', isSafety: false },
  rear_right_quarter_panel: { price: 0, nameEn: 'rear right quarter panel', nameAr: 'رفرف خلفي يمين', partId: 'PT_0032', category: 'panels', isSafety: false },
  b_pillar: { price: 0, nameEn: 'B pillar', nameAr: 'قايم وسط', partId: 'PT_0033', category: 'chassis_structure', isSafety: false },
  right_mirror: { price: 0, nameEn: 'right mirror', nameAr: 'مراية يمين', partId: 'PT_0034', category: 'exterior', isSafety: false },
  front_right_door_window: { price: 0, nameEn: 'front right door window', nameAr: 'زجاج باب أمامي يمين', partId: 'PT_0035', category: 'glass', isSafety: false },
  rear_right_door_window: { price: 0, nameEn: 'rear right door window', nameAr: 'زجاج باب خلفي يمين', partId: 'PT_0036', category: 'glass', isSafety: false },
  front_right_door_trim: { price: 0, nameEn: 'front right door trim', nameAr: 'تريم/حلية باب أمامي يمين', partId: 'PT_0037', category: 'exterior', isSafety: false },
  rear_right_door_trim: { price: 0, nameEn: 'rear right door trim', nameAr: 'تريم/حلية باب خلفي يمين', partId: 'PT_0038', category: 'exterior', isSafety: false },
  front_right_door_handle: { price: 0, nameEn: 'front right door handle', nameAr: 'أوكره/مقبض باب أمامي يمين', partId: 'PT_0039', category: 'exterior', isSafety: false },
  rear_right_door_handle: { price: 0, nameEn: 'rear right door handle', nameAr: 'أوكره/مقبض باب خلفي يمين', partId: 'PT_0040', category: 'exterior', isSafety: false },
  rear_bumper_upper: { price: 0, nameEn: 'rear bumper upper', nameAr: 'اكصدام خلفي علوي', partId: 'PT_0041', category: 'panels', isSafety: false },
  rear_bumper_lower: { price: 0, nameEn: 'rear bumper lower', nameAr: 'اكصدام خلفي سفلي', partId: 'PT_0042', category: 'panels', isSafety: false },
  rear_wiper: { price: 0, nameEn: 'rear wiper', nameAr: 'مسّاحة خلفي', partId: 'PT_0043', category: 'exterior', isSafety: false },
  c_pillar: { price: 0, nameEn: 'C pillar', nameAr: 'قايم خلفي', partId: 'PT_0044', category: 'chassis_structure', isSafety: false },
  rear_windshield: { price: 0, nameEn: 'rear windshield', nameAr: 'زجاج خلفي', partId: 'PT_0045', category: 'glass', isSafety: false },
  rear_left_headlight_inner: { price: 0, nameEn: 'rear left headlight inner', nameAr: 'فانوس خلفي شمال (داخلي)', partId: 'PT_0046', category: 'exterior', isSafety: false },
  rear_right_headlight_inner: { price: 0, nameEn: 'rear right headlight inner', nameAr: 'فانوس خلفي يمين (داخلي)', partId: 'PT_0047', category: 'exterior', isSafety: false },
  rear_left_headlight_outer: { price: 0, nameEn: 'rear left headlight outer', nameAr: 'فانوس خلفي شمال (خارجي)', partId: 'PT_0048', category: 'exterior', isSafety: false },
  rear_right_headlight_outer: { price: 0, nameEn: 'rear right headlight outer', nameAr: 'فانوس خلفي يمين (خارجي)', partId: 'PT_0049', category: 'exterior', isSafety: false },
  trunk_door: { price: 0, nameEn: 'trunk door', nameAr: 'باب الشنطة', partId: 'PT_0050', category: 'panels', isSafety: false },
  rear_car_logo: { price: 0, nameEn: 'rear car logo', nameAr: 'شعار العربية (خلفي)', partId: 'PT_0051', category: 'exterior', isSafety: false },
  front_left_tire: { price: 0, nameEn: 'front left tire', nameAr: 'كوتش أمامي شمال', partId: 'PT_0052', category: 'suspension', isSafety: false },
  front_right_tire: { price: 0, nameEn: 'front right tire', nameAr: 'كوتش أمامي يمين', partId: 'PT_0053', category: 'suspension', isSafety: false },
  rear_right_tire: { price: 0, nameEn: 'rear right tire', nameAr: 'كوتش خلفي يمين', partId: 'PT_0054', category: 'suspension', isSafety: false },
  rear_left_tire: { price: 0, nameEn: 'rear left tire', nameAr: 'كوتش خلفي شمال', partId: 'PT_0055', category: 'suspension', isSafety: false },
  front_left_wheel: { price: 0, nameEn: 'front left wheel', nameAr: 'جنط أمامي شمال', partId: 'PT_0056', category: 'suspension', isSafety: false },
  front_right_wheel: { price: 0, nameEn: 'front right wheel', nameAr: 'جنط أمامي يمين', partId: 'PT_0057', category: 'suspension', isSafety: false },
  rear_right_wheel: { price: 0, nameEn: 'rear right wheel', nameAr: 'جنط خلفي يمين', partId: 'PT_0058', category: 'suspension', isSafety: false },
  rear_left_wheel: { price: 0, nameEn: 'rear left wheel', nameAr: 'جنط خلفي شمال', partId: 'PT_0059', category: 'suspension', isSafety: false },
  roof_window: { price: 0, nameEn: 'roof window', nameAr: 'فتحة سقف', partId: 'PT_0060', category: 'glass', isSafety: false },
  roof_trims: { price: 0, nameEn: 'roof trims', nameAr: 'حليات/تريم السقف', partId: 'PT_0061', category: 'exterior', isSafety: false },
  aerial: { price: 0, nameEn: 'aerial', nameAr: 'أريال', partId: 'PT_0062', category: 'exterior', isSafety: false },
  front_left_fender_liner: { price: 0, nameEn: 'front left fender liner', nameAr: 'داير رفرف امامي شمال', partId: 'PT_0063', category: 'exterior', isSafety: false },
  front_right_fender_liner: { price: 0, nameEn: 'front right fender liner', nameAr: 'داير رفرف امامي يمين', partId: 'PT_0064', category: 'exterior', isSafety: false },
  rear_left_fender_liner: { price: 0, nameEn: 'rear left fender liner', nameAr: 'داير رفرف خلفي شمال', partId: 'PT_0065', category: 'exterior', isSafety: false },
  rear_right_fender_liner: { price: 0, nameEn: 'rear right fender liner', nameAr: 'داير رفرف خلفي يمين', partId: 'PT_0066', category: 'exterior', isSafety: false },
  tableau: { price: 0, nameEn: 'tableau', nameAr: 'تابلوه', partId: 'PT_0067', category: 'interior', isSafety: false },
  dashboard_internal_structure: { price: 0, nameEn: 'dashboard internal structure', nameAr: 'تابلوه', partId: 'PT_0068', category: 'interior', isSafety: false },
  washer_fluid_reservoir: { price: 0, nameEn: 'washer fluid reservoir', nameAr: 'قربه مياه مساحات', partId: 'PT_0069', category: 'mechanical', isSafety: false },
  ...
  exhaust_manifold: { price: 0, nameEn: 'exhaust manifold', nameAr: 'مانيفولد الشكمان', partId: 'PT_0101', category: 'mechanical', isSafety: false },
  exhaust_front_pipe: { price: 0, nameEn: 'exhaust front pipe', nameAr: 'ماسورة الشكمان الأمامية', partId: 'PT_0102', category: 'mechanical', isSafety: false },
  ...
  engine_oil_pan: { price: 0, nameEn: 'engine oil pan', nameAr: 'كرتيرة زيت الموتور', partId: 'PT_0109', category: 'mechanical', isSafety: false },
  transmission_housing: { price: 0, nameEn: 'transmission housing', nameAr: 'جسم/علبة الفتيس', partId: 'PT_0110', category: 'mechanical', isSafety: false },
  transmission_oil_pan: { price: 0, nameEn: 'transmission oil pan', nameAr: 'كرتيرة زيت الفتيس', partId: 'PT_0111', category: 'mechanical', isSafety: false },
  engine_mounts: { price: 0, nameEn: 'engine mounts', nameAr: 'قواعد الموتور', partId: 'PT_0112', category: 'mechanical', isSafety: false },
  transmission_mounts: { price: 0, nameEn: 'transmission mounts', nameAr: 'قواعد الفتيس', partId: 'PT_0113', category: 'mechanical', isSafety: false },
  driveshaft: { price: 0, nameEn: 'driveshaft', nameAr: 'عمود الكردان', partId: 'PT_0114', category: 'mechanical', isSafety: false },
  ...
  coolant_pump: { price: 0, nameEn: 'coolant pump', nameAr: 'طلمبة مياه', partId: 'PT_0122', category: 'cooling', isSafety: false },
  radiator_hoses: { price: 0, nameEn: 'radiator hoses', nameAr: 'خراطيم الردياتير', partId: 'PT_0123', category: 'cooling', isSafety: false },
  turbo_coolant_hoses: { price: 0, nameEn: 'turbo coolant hoses', nameAr: 'خراطيم مياه التيربو', partId: 'PT_0124', category: 'cooling', isSafety: false },
  radiator_fan: { price: 0, nameEn: 'radiator fan', nameAr: 'مروحة الردياتير', partId: 'PT_0125', category: 'cooling', isSafety: false },
  fan_motor: { price: 0, nameEn: 'fan motor', nameAr: 'موتور المروحة', partId: 'PT_0126', category: 'cooling', isSafety: false },
  front_right_shock_absorber: { price: 0, nameEn: 'front right shock absorber', nameAr: 'مساعد أمامي يمين', partId: 'PT_0127', category: 'suspension', isSafety: false },
  front_left_shock_absorber: { price: 0, nameEn: 'front left shock absorber', nameAr: 'مساعد أمامي شمال', partId: 'PT_0128', category: 'suspension', isSafety: false },
  rear_left_shock_absorber: { price: 0, nameEn: 'rear left shock absorber', nameAr: 'مساعد خلفي شمال', partId: 'PT_0129', category: 'suspension', isSafety: false },
  rear_right_shock_absorber: { price: 0, nameEn: 'rear right shock absorber', nameAr: 'مساعد خلفي يمين', partId: 'PT_0130', category: 'suspension', isSafety: false },
  front_right_control_arm: { price: 0, nameEn: 'front right control arm', nameAr: 'مقص أمامي يمين', partId: 'PT_0131', category: 'suspension', isSafety: false },
  front_left_control_arm: { price: 0, nameEn: 'front left control arm', nameAr: 'مقص أمامي شمال', partId: 'PT_0132', category: 'suspension', isSafety: false },
  rear_right_control_arm: { price: 0, nameEn: 'rear right control arm', nameAr: 'مقص خلفي يمين', partId: 'PT_0133', category: 'suspension', isSafety: false },
  rear_left_control_arm: { price: 0, nameEn: 'rear left control arm', nameAr: 'مقص خلفي شمال', partId: 'PT_0134', category: 'suspension', isSafety: false },
  front_right_steering_knuckle: { price: 0, nameEn: 'front right steering knuckle', nameAr: 'شمعدان امامي يمين', partId: 'PT_0135', category: 'suspension', isSafety: false },
  front_left_steering_knuckle: { price: 0, nameEn: 'front left steering knuckle', nameAr: 'شمعدان امامي شمال', partId: 'PT_0136', category: 'suspension', isSafety: false },
  rear_right_steering_knuckle: { price: 0, nameEn: 'rear right steering knuckle', nameAr: 'شمعدان خلفي يمين', partId: 'PT_0137', category: 'suspension', isSafety: false },
  rear_left_steering_knuckle: { price: 0, nameEn: 'rear left steering knuckle', nameAr: 'شمعدان خلفي شمال', partId: 'PT_0138', category: 'suspension', isSafety: false },
  steering_rack: { price: 0, nameEn: 'steering rack', nameAr: 'علبة الدريكسيون', partId: 'PT_0139', category: 'suspension', isSafety: false },
  steering_column: { price: 0, nameEn: 'steering column', nameAr: 'عمود الدريكسيون', partId: 'PT_0140', category: 'suspension', isSafety: false },
  ...
  rear_left_suspension_assembly: { price: 0, nameEn: 'rear left suspension assembly', nameAr: 'مساعد خلفي شمال', partId: 'PT_0147', category: 'suspension', isSafety: false },
  rear_right_suspension_assembly: { price: 0, nameEn: 'rear right suspension assembly', nameAr: 'مساعد خلفي يمين', partId: 'PT_0148', category: 'suspension', isSafety: false },
  cooling_system: { price: 0, nameEn: 'cooling system', nameAr: 'طقم تبريد', partId: 'PT_0149', category: 'cooling', isSafety: false },
  ...
  front_bumper_chassis_bar: { price: 0, nameEn: 'front bumper chassis bar', nameAr: 'عارضة/حديد الصدام الأمامي', partId: 'PT_0157', category: 'chassis_structure', isSafety: false },
  front_carrier: { price: 0, nameEn: 'front carrier', nameAr: 'صدر أمامي (حامل ردياتير)', partId: 'PT_0158', category: 'mechanical', isSafety: false },
  rear_bumper_chassis_bar: { price: 0, nameEn: 'rear bumper chassis bar', nameAr: 'عارضة/حديد الصدام الخلفي', partId: 'PT_0159', category: 'chassis_structure', isSafety: false },
  rear_bumper_crash_foam: { price: 0, nameEn: 'rear bumper crash foam', nameAr: 'فوم اكصدام خلفي', partId: 'PT_0160', category: 'chassis_structure', isSafety: false },
  front_right_cross_member: { price: 0, nameEn: 'front right cross member', nameAr: 'فرده شاسيه أمامية يمين', partId: 'PT_0161', category: 'chassis_structure', isSafety: false },
  front_left_cross_member: { price: 0, nameEn: 'front left cross member', nameAr: 'فرده شاسيه أمامية شمال', partId: 'PT_0162', category: 'chassis_structure', isSafety: false },
  hood_latch: { price: 0, nameEn: 'hood latch', nameAr: 'كالون/قفل الكبوت', partId: 'PT_0163', category: 'exterior', isSafety: false },
  ...
  rear_left_cross_member: { price: 0, nameEn: 'rear left cross member', nameAr: 'فرده شاسيه خلفية شمال', partId: 'PT_0170', category: 'chassis_structure', isSafety: false },
  spare_tire_pan: { price: 0, nameEn: 'spare tire pan', nameAr: 'حله الاستبن', partId: 'PT_0171', category: 'chassis_structure', isSafety: false },
  rear_right_pan_panel: { price: 0, nameEn: 'rear right pan panel', nameAr: 'كرتيره صاج خلفي يمين', partId: 'PT_0172', category: 'chassis_structure', isSafety: false },
  rear_left_pan_panel: { price: 0, nameEn: 'rear left pan panel', nameAr: 'كرتيره صاج خلفي شمال', partId: 'PT_0173', category: 'chassis_structure', isSafety: false },
  rear_right_inner_pillar: { price: 0, nameEn: 'rear right inner pillar', nameAr: 'قايم داخلي خلفي يمين', partId: 'PT_0174', category: 'chassis_structure', isSafety: false },
  rear_left_inner_pillar: { price: 0, nameEn: 'rear left inner pillar', nameAr: 'قايم داخلي خلفي شمال', partId: 'PT_0175', category: 'chassis_structure', isSafety: false },
  front_right_inner_pillar: { price: 0, nameEn: 'front right inner pillar', nameAr: 'قايم داخلي أمامي يمين', partId: 'PT_0176', category: 'chassis_structure', isSafety: false },
  front_left_inner_pillar: { price: 0, nameEn: 'front left inner pillar', nameAr: 'قايم داخلي أمامي شمال', partId: 'PT_0177', category: 'chassis_structure', isSafety: false },
  front_right_door_hinge: { price: 0, nameEn: 'front right door hinge', nameAr: 'مفصلة باب أمامي يمين', partId: 'PT_0178', category: 'exterior', isSafety: false },
  front_left_door_hinge: { price: 0, nameEn: 'front left door hinge', nameAr: 'مفصلة باب أمامي شمال', partId: 'PT_0179', category: 'exterior', isSafety: false },
  rear_right_door_hinge: { price: 0, nameEn: 'rear right door hinge', nameAr: 'مفصلة باب خلفي يمين', partId: 'PT_0180', category: 'exterior', isSafety: false },
  rear_left_door_hinge: { price: 0, nameEn: 'rear left door hinge', nameAr: 'مفصلة باب خلفي شمال', partId: 'PT_0181', category: 'exterior', isSafety: false },
  left_front_door_hinges: { price: 0, nameEn: 'left front door hinges', nameAr: 'مفصلات أبواب شمال', partId: 'PT_0182', category: 'exterior', isSafety: false },
  rear_panel: { price: 0, nameEn: 'rear panel', nameAr: 'ضهر صاج خلفي', partId: 'PT_0183', category: 'chassis_structure', isSafety: false },
  rear_body_panel: { price: 0, nameEn: 'rear body panel', nameAr: 'ضهر صاج', partId: 'PT_0184', category: 'chassis_structure', isSafety: false },
  front_impact_bar: { price: 0, nameEn: 'front impact bar', nameAr: 'شاسيه اكصدام امامي', partId: 'PT_0185', category: 'chassis_structure', isSafety: false },
  rear_impact_bar: { price: 0, nameEn: 'rear impact bar', nameAr: 'شاسيه اكصدام خلفي', partId: 'PT_0186', category: 'chassis_structure', isSafety: false },
  radiator_support: { price: 0, nameEn: 'radiator support', nameAr: 'صدر فبر', partId: 'PT_0187', category: 'mechanical', isSafety: false },
  radiator_support_core_support: { price: 0, nameEn: 'Radiator Support / Core Support', nameAr: 'صدر فبر', partId: 'PT_0188', category: 'mechanical', isSafety: false },
  radiator_core_support: { price: 0, nameEn: 'radiator core support', nameAr: 'صدر فبر', partId: 'PT_0189', category: 'mechanical', isSafety: false },
  headlight_mounting_brackets: { price: 0, nameEn: 'headlight mounting brackets', nameAr: 'قواعد فوانيس امامي', partId: 'PT_0190', category: 'exterior', isSafety: false },
  trunk_latch_and_striker: { price: 0, nameEn: 'trunk latch and striker', nameAr: 'كالون شنطه', partId: 'PT_0191', category: 'exterior', isSafety: false },
  trunk_latch: { price: 0, nameEn: 'trunk latch', nameAr: 'كالون شنطه', partId: 'PT_0192', category: 'exterior', isSafety: false },
  liftgate_struts: { price: 0, nameEn: 'liftgate struts', nameAr: 'مساعدين شنطه', partId: 'PT_0193', category: 'exterior', isSafety: false },
  ...
  rear_frame_rail_right: { price: 0, nameEn: 'rear frame rail right', nameAr: 'سلاح رفرف خلفي يمين', partId: 'PT_0200', category: 'chassis_structure', isSafety: false },
  front_left_chassis_rail: { price: 0, nameEn: 'front left chassis rail', nameAr: 'سلاح رفرف امامي شمال', partId: 'PT_0201', category: 'chassis_structure', isSafety: false },
  front_bulkhead: { price: 0, nameEn: 'front bulkhead', nameAr: 'صدر السيارة', partId: 'PT_0202', category: 'chassis_structure', isSafety: false },
  trunk_hinges: { price: 0, nameEn: 'Trunk hinges', nameAr: 'مفصلات شنطه', partId: 'PT_0203', category: 'exterior', isSafety: false },
  trunk_chrome_trim: { price: 0, nameEn: 'Trunk chrome trim / garnish', nameAr: 'نيكل شنطة', partId: 'PT_0204', category: 'exterior', isSafety: false },
  trunk_emblems: { price: 0, nameEn: 'Trunk emblems / badges', nameAr: 'علامات شنطه', partId: 'PT_0205', category: 'exterior', isSafety: false },
  trunk_interior_lining: { price: 0, nameEn: 'Trunk interior trim/lining', nameAr: 'فرش شنطه', partId: 'PT_0206', category: 'exterior', isSafety: false },
  trunk_interior_plastic_trim: { price: 0, nameEn: 'Trunk interior plastic trim', nameAr: 'فيبر شنطة داخلي', partId: 'PT_0207', category: 'exterior', isSafety: false },
  rear_parcel_shelf: { price: 0, nameEn: 'Rear parcel shelf (plastic)', nameAr: 'رف شنطه فيبر', partId: 'PT_0208', category: 'exterior', isSafety: false },
  rear_bumper_lower_valance: { price: 0, nameEn: 'Rear bumper lower valance (plastic)', nameAr: 'كساحه اكصدام خلفي فيبر', partId: 'PT_0209', category: 'exterior', isSafety: false },
  rear_reflector_right: { price: 0, nameEn: 'Rear reflector', nameAr: 'عاكس خلفي يمين', partId: 'PT_0210', category: 'exterior', isSafety: false },
  rear_reflector_left: { price: 0, nameEn: 'Rear reflector', nameAr: 'عاكس خلفي شمال', partId: 'PT_0211', category: 'exterior', isSafety: false },
  trunk_mounted_tail_light: { price: 0, nameEn: 'Trunk-mounted tail light', nameAr: 'فانوس شنطه', partId: 'PT_0212', category: 'exterior', isSafety: false },
  trunk_spoiler: { price: 0, nameEn: 'Trunk spoiler', nameAr: 'اسبويلر شنطه', partId: 'PT_0213', category: 'exterior', isSafety: false },
  rear_bumper_chrome_trim: { price: 0, nameEn: 'Rear bumper chrome trim', nameAr: 'نيكل اكصدام خلفي', partId: 'PT_0214', category: 'exterior', isSafety: false },
  exhaust_tip_trim: { price: 0, nameEn: 'Exhaust tip trim/garnish', nameAr: 'حليه شكامان', partId: 'PT_0215', category: 'exterior', isSafety: false },
  trunk_sheet_metal: { price: 0, nameEn: 'Trunk (sheet metal)', nameAr: 'حلق شنطه صاج', partId: 'PT_0216', category: 'chassis_structure', isSafety: false },
  roof_trim_right: { price: 0, nameEn: 'Roof trim', nameAr: 'فيبره سقف يمين', partId: 'PT_0217', category: 'exterior', isSafety: false },
  roof_trim_left: { price: 0, nameEn: 'Roof trim', nameAr: 'فيبره سقف شمال', partId: 'PT_0218', category: 'exterior', isSafety: false },
  front_bumper_lower_valance: { price: 0, nameEn: 'Front bumper lower valance (plastic)', nameAr: 'كساحه اكصدام امامي فيبر', partId: 'PT_0219', category: 'exterior', isSafety: false },
  front_bumper_brackets: { price: 0, nameEn: 'Front bumper brackets/mounts', nameAr: 'قواعد اكصدام امامي', partId: 'PT_0220', category: 'exterior', isSafety: false },
  hood_hinges: { price: 0, nameEn: 'Hood hinges', nameAr: 'مفصلات كبود', partId: 'PT_0221', category: 'exterior', isSafety: false },
  hood_struts: { price: 0, nameEn: 'Hood struts', nameAr: 'مساعدين كبود', partId: 'PT_0222', category: 'exterior', isSafety: false },
  hood_shocks: { price: 0, nameEn: 'Hood shocks', nameAr: 'مفجرات كبود', partId: 'PT_0223', category: 'airbags_safety', isSafety: false },
  hood_to_fender_rubber_seal: { price: 0, nameEn: 'Hood-to-fender rubber seal', nameAr: 'شنب كبود', partId: 'PT_0224', category: 'exterior', isSafety: false },
  front_bumper_chrome_trim: { price: 0, nameEn: 'Front bumper chrome trim', nameAr: 'نيكل اكصدام امامي', partId: 'PT_0225', category: 'exterior', isSafety: false },
  front_bumper_chrome_trim_right: { price: 0, nameEn: 'Front bumper chrome trim', nameAr: 'نيكل اكصدام امامي يمين', partId: 'PT_0226', category: 'exterior', isSafety: false },
  front_bumper_chrome_trim_left: { price: 0, nameEn: 'Front bumper chrome trim', nameAr: 'نيكل اكصدام امامي شمال', partId: 'PT_0227', category: 'exterior', isSafety: false },
  rear_license_plate_bracket: { price: 0, nameEn: 'Rear license plate trim/bracket', nameAr: 'فيبره نمره خلفي', partId: 'PT_0228', category: 'exterior', isSafety: false },
  rear_fender_arch_liner_right: { price: 0, nameEn: 'Rear fender arch liner', nameAr: 'كارتيره رفرف خلفي يمين', partId: 'PT_0229', category: 'exterior', isSafety: false },
  rear_fender_arch_liner_left: { price: 0, nameEn: 'Rear fender arch liner', nameAr: 'كارتيره رفرف خلفي شمال', partId: 'PT_0230', category: 'exterior', isSafety: false },
  front_bumper_foam: { price: 0, nameEn: 'Front bumper foam', nameAr: 'فوم اكصدام امامي', partId: 'PT_0231', category: 'exterior', isSafety: false },
  alternator: { price: 0, nameEn: 'Alternator', nameAr: 'دينامو', partId: 'PT_0232', category: 'mechanical', isSafety: false },
  ac_compressor: { price: 0, nameEn: 'AC compressor', nameAr: 'كمبرسور تكييف', partId: 'PT_0233', category: 'mechanical', isSafety: false },
  ac_pipes_lines: { price: 0, nameEn: 'AC pipes/lines', nameAr: 'مواسير تكييف', partId: 'PT_0234', category: 'mechanical', isSafety: false },
  radiator_hoses_assembly: { price: 0, nameEn: 'Radiator hoses', nameAr: 'شجره مياه تبريد', partId: 'PT_0235', category: 'mechanical', isSafety: false },
  turbocharger: { price: 0, nameEn: 'Turbocharger', nameAr: 'تربو', partId: 'PT_0236', category: 'mechanical', isSafety: false },
  battery_tray: { price: 0, nameEn: 'Battery tray', nameAr: 'قاعده بطاريه', partId: 'PT_0237', category: 'mechanical', isSafety: false },
  air_filter_box: { price: 0, nameEn: 'Air filter box (airbox)', nameAr: 'عمه هوا', partId: 'PT_0238', category: 'mechanical', isSafety: false },
  air_intake_hose: { price: 0, nameEn: 'Air intake hose', nameAr: 'خرطوم عمه هوا', partId: 'PT_0239', category: 'mechanical', isSafety: false },
  engine_cover: { price: 0, nameEn: 'Engine cover', nameAr: 'كفر ماتور', partId: 'PT_0240', category: 'mechanical', isSafety: false },
  serpentine_belt: { price: 0, nameEn: 'Serpentine / drive belt', nameAr: 'سير مجموعة', partId: 'PT_0241', category: 'mechanical', isSafety: false },
  alternator_belt: { price: 0, nameEn: 'Alternator belt', nameAr: 'سير دينامو', partId: 'PT_0242', category: 'mechanical', isSafety: false },
  front_right_wheel_hub_bearing: { price: 0, nameEn: 'Front right wheel hub/bearing', nameAr: 'صره عجل امامي يمين', partId: 'PT_0243', category: 'suspension', isSafety: false },
  front_left_wheel_hub_bearing: { price: 0, nameEn: 'Front left wheel hub/bearing', nameAr: 'صره عجل امامي شمال', partId: 'PT_0244', category: 'suspension', isSafety: false },
  ...
  rear_left_door_panel_trim: { price: 0, nameEn: 'Rear left door panel trim', nameAr: 'فرش باب خلفي شمال', partId: 'PT_0252', category: 'interior', isSafety: false },
  right_seat_upholstery: { price: 0, nameEn: 'Right seat upholstery', nameAr: 'فرش كرسي يمين', partId: 'PT_0253', category: 'interior', isSafety: false },
  left_seat_upholstery: { price: 0, nameEn: 'Left seat upholstery', nameAr: 'فرش كرسي شمال', partId: 'PT_0254', category: 'interior', isSafety: false },
  rear_bench_seat_upholstery: { price: 0, nameEn: 'Rear bench seat upholstery', nameAr: 'فرش كنبه', partId: 'PT_0255', category: 'interior', isSafety: false },
  armrest: { price: 0, nameEn: 'Armrest', nameAr: 'مسند يد', partId: 'PT_0256', category: 'interior', isSafety: false },
  center_console: { price: 0, nameEn: 'Center console', nameAr: 'كونصله', partId: 'PT_0257', category: 'interior', isSafety: false },
  glove_box: { price: 0, nameEn: 'Glove box', nameAr: 'درج تابلوه', partId: 'PT_0258', category: 'interior', isSafety: false },
  interior_rearview_mirror: { price: 0, nameEn: 'Interior rearview mirror', nameAr: 'مرايا صالون', partId: 'PT_0259', category: 'interior', isSafety: false },
  front_pillar_trim_right: { price: 0, nameEn: 'Front pillar trim', nameAr: 'قايم فيبر امامي يمين', partId: 'PT_0260', category: 'interior', isSafety: false },
  rear_pillar_trim_right: { price: 0, nameEn: 'Rear pillar trim', nameAr: 'قايم فيبر خلفي يمين', partId: 'PT_0261', category: 'interior', isSafety: false },
  front_pillar_trim_left: { price: 0, nameEn: 'Front pillar trim', nameAr: 'قايم فيبر امامي شمال', partId: 'PT_0262', category: 'interior', isSafety: false },
  rear_pillar_trim_left: { price: 0, nameEn: 'Rear pillar trim', nameAr: 'قايم فيبر خلفي شمال', partId: 'PT_0263', category: 'interior', isSafety: false },
  middle_b_pillar_trim_right: { price: 0, nameEn: 'Middle (B-)pillar trim', nameAr: 'قايم فيبر وسط يمين', partId: 'PT_0264', category: 'interior', isSafety: false },
  middle_b_pillar_trim_left: { price: 0, nameEn: 'Middle (B-)pillar trim', nameAr: 'قايم فيبر وسط شمال', partId: 'PT_0265', category: 'interior', isSafety: false },
  head_unit_infotainment_screen: { price: 0, nameEn: 'Head unit / infotainment screen', nameAr: 'شاشه كاسيت', partId: 'PT_0266', category: 'interior', isSafety: false },
  ac_vent_right: { price: 0, nameEn: 'AC vent', nameAr: 'هوايه تكييف يمين', partId: 'PT_0267', category: 'interior', isSafety: false },
  ac_vent_left: { price: 0, nameEn: 'AC vent', nameAr: 'هوايه تكييف شمال', partId: 'PT_0268', category: 'interior', isSafety: false },
  ac_vent_middle_right: { price: 0, nameEn: 'AC vent', nameAr: 'هوايه تكييف وسط يمين', partId: 'PT_0269', category: 'interior', isSafety: false },
  ac_vent_middle_left: { price: 0, nameEn: 'AC vent', nameAr: 'هوايه تكييف وسط شمال', partId: 'PT_0270', category: 'interior', isSafety: false },
  ac_vent_rear_right: { price: 0, nameEn: 'AC vent', nameAr: 'هوايه تكييف خلفي يمين', partId: 'PT_0271', category: 'interior', isSafety: false },
  ac_vent_rear_left: { price: 0, nameEn: 'AC vent', nameAr: 'هوايه تكييف خلفي شمال', partId: 'PT_0272', category: 'interior', isSafety: false },
  front_left_door_lock_latch: { price: 0, nameEn: 'Front left door lock/latch', nameAr: 'كالون باب امامي شمال', partId: 'PT_0273', category: 'exterior', isSafety: false },
  front_right_door_lock_latch: { price: 0, nameEn: 'Front right door lock/latch', nameAr: 'كالون باب امامي يمين', partId: 'PT_0274', category: 'exterior', isSafety: false },
  rear_left_door_lock_latch: { price: 0, nameEn: 'Rear left door lock/latch', nameAr: 'كالون باب خلفي شمال', partId: 'PT_0275', category: 'exterior', isSafety: false },
  rear_right_door_lock_latch: { price: 0, nameEn: 'Rear right door lock/latch', nameAr: 'كالون باب خلفي يمين', partId: 'PT_0276', category: 'exterior', isSafety: false },
  front_right_door_check_strap: { price: 0, nameEn: 'Front right door check strap/limiter', nameAr: 'شداد باب امامي يمين', partId: 'PT_0277', category: 'exterior', isSafety: false },
  rear_left_door_check_strap: { price: 0, nameEn: 'Rear left door check strap/limiter', nameAr: 'شداد باب خلفي شمال', partId: 'PT_0278', category: 'exterior', isSafety: false },
  front_left_door_check_strap: { price: 0, nameEn: 'Front left door check strap/limiter', nameAr: 'شداد باب امامي شمال', partId: 'PT_0279', category: 'exterior', isSafety: false },
  rear_right_door_check_strap: { price: 0, nameEn: 'Rear right door check strap/limiter', nameAr: 'شداد باب خلفي يمين', partId: 'PT_0280', category: 'exterior', isSafety: false },
  side_curtain_airbag_strip: { price: 0, nameEn: 'Side curtain airbag strip', nameAr: 'شريط ايرباج', partId: 'PT_0281', category: 'airbags_safety', isSafety: false },
  front_right_window_weatherstrip: { price: 0, nameEn: 'Front right window weatherstrip/seal', nameAr: 'استفه زجاج امامي يمين', partId: 'PT_0282', category: 'exterior', isSafety: false },
  front_left_window_weatherstrip: { price: 0, nameEn: 'Front left window weatherstrip/seal', nameAr: 'استفه زجاج امامي شمال', partId: 'PT_0283', category: 'exterior', isSafety: false },
  rear_right_window_weatherstrip: { price: 0, nameEn: 'Rear right window weatherstrip/seal', nameAr: 'استفه زجاج خلفي يمين', partId: 'PT_0284', category: 'exterior', isSafety: false },
  rear_left_window_weatherstrip: { price: 0, nameEn: 'Rear left window weatherstrip/seal', nameAr: 'استفه زجاج خلفي شمال', partId: 'PT_0285', category: 'exterior', isSafety: false },
  right_mirror_cover: { price: 0, nameEn: 'Right mirror cover/cap', nameAr: 'كفر مرايا يمين', partId: 'PT_0286', category: 'exterior', isSafety: false },
  left_mirror_cover: { price: 0, nameEn: 'Left mirror cover/cap', nameAr: 'كفر مرايا شمال', partId: 'PT_0287', category: 'exterior', isSafety: false },
  right_mirror_turn_signal: { price: 0, nameEn: 'Right mirror turn signal', nameAr: 'غماز مرايا يمين', partId: 'PT_0288', category: 'exterior', isSafety: false },
  left_mirror_turn_signal: { price: 0, nameEn: 'Left mirror turn signal', nameAr: 'غماز مرايا شمال', partId: 'PT_0289', category: 'exterior', isSafety: false },
  front_right_door_chrome_trim: { price: 0, nameEn: 'Front right door chrome trim', nameAr: 'نيكل باب امامي يمين', partId: 'PT_0290', category: 'exterior', isSafety: false },
  rear_right_door_chrome_trim: { price: 0, nameEn: 'Rear right door chrome trim', nameAr: 'نيكل باب خلفي يمين', partId: 'PT_0291', category: 'exterior', isSafety: false },
  front_left_door_chrome_trim: { price: 0, nameEn: 'Front left door chrome trim', nameAr: 'نيكل باب امامي شمال', partId: 'PT_0292', category: 'exterior', isSafety: false },
  rear_left_door_chrome_trim: { price: 0, nameEn: 'Rear left door chrome trim', nameAr: 'نيكل باب خلفي شمال', partId: 'PT_0293', category: 'exterior', isSafety: false },
  rear_right_quarter_vent_glass: { price: 0, nameEn: 'Rear right quarter/vent glass', nameAr: 'شراعه زجاج خلفي يمين', partId: 'PT_0294', category: 'exterior', isSafety: false },
  rear_left_quarter_vent_glass: { price: 0, nameEn: 'Rear left quarter/vent glass', nameAr: 'شراعه زجاج خلفي شمال', partId: 'PT_0295', category: 'exterior', isSafety: false },
  ambient_air_temperature_sensor: { price: 0, nameEn: 'Outside/ambient air temperature sensor', nameAr: 'حساس هوا خارجي', partId: 'PT_0296', category: 'mechanical', isSafety: false },
  oxygen_o2_sensor: { price: 0, nameEn: 'Oxygen (O2) sensor', nameAr: 'حساس اكسجين', partId: 'PT_0297', category: 'mechanical', isSafety: false },
  thermostat_sensor: { price: 0, nameEn: 'Thermostat sensor', nameAr: 'حساس ثرموستات', partId: 'PT_0298', category: 'mechanical', isSafety: false },
  rain_sensor: { price: 0, nameEn: 'Rain sensor', nameAr: 'حساس مطر', partId: 'PT_0299', category: 'mechanical', isSafety: false },
  transmission_input_speed_sensor: { price: 0, nameEn: 'Transmission input speed sensor', nameAr: 'حساس فتيس علوي', partId: 'PT_0300', category: 'mechanical', isSafety: false },
  transmission_output_speed_sensor: { price: 0, nameEn: 'Transmission output speed sensor', nameAr: 'حساس فتيس سفلي', partId: 'PT_0301', category: 'mechanical', isSafety: false },
  front_right_wheel_speed_sensor_abs: { price: 0, nameEn: 'Front right wheel speed sensor (ABS)', nameAr: 'حساس عجل امامي يمين', partId: 'PT_0302', category: 'mechanical', isSafety: false },
  front_left_wheel_speed_sensor_abs: { price: 0, nameEn: 'Front left wheel speed sensor (ABS)', nameAr: 'حساس عجل امامي شمال', partId: 'PT_0303', category: 'mechanical', isSafety: false },
  rear_right_wheel_speed_sensor_abs: { price: 0, nameEn: 'Rear right wheel speed sensor (ABS)', nameAr: 'حساس عجل خلفي يمين', partId: 'PT_0304', category: 'mechanical', isSafety: false },
  rear_left_wheel_speed_sensor_abs: { price: 0, nameEn: 'Rear left wheel speed sensor (ABS)', nameAr: 'حساس عجل خلفي شمال', partId: 'PT_0305', category: 'mechanical', isSafety: false },
  rear_left_headlight: { price: 0, nameEn: 'rear left headlight', nameAr: 'فانوس خلفي يمين', partId: 'PT_0306', category: 'exterior', isSafety: false },
  rear_right_headlight: { price: 0, nameEn: 'rear right headlight', nameAr: 'فانوس خلفي شمال', partId: 'PT_0307', category: 'exterior', isSafety: false },
};
...
const PART_TAXONOMY_V3 = [
  ...
  { partId: 'PT_0088', key: 'bcm_module', aliases: ['body_control_module'] },
  { partId: 'PT_0089', key: 'ecm_module', aliases: ['engine_control_module'] },
  { partId: 'PT_0090', key: 'tcm_module', aliases: ['transmission_control_module'] },
  { partId: 'PT_0091', key: 'adas_module', aliases: ['adas_control_module'] },
  ...
  { partId: 'PT_0097', key: 'rear_harness', aliases: ['rear_wiring_harness_and_sensors', 'parking_sensor_wiring_harness'] },
  { partId: 'PT_0099', key: 'rear_parking_sensor_harness', aliases: ['rear_wiring_harness_and_sensors', 'parking_sensor_wiring_harness'] },
  ...
  { partId: 'PT_0103', key: 'exhaust_middle_pipe', aliases: ['center_exhaust_pipe'] },
  { partId: 'PT_0104', key: 'exhaust_rear_pipe', aliases: [] },
  { partId: 'PT_0105', key: 'brake_hoses', aliases: ['brake_lines_hoses'] },
  { partId: 'PT_0106', key: 'gas_hoses', aliases: ['fuel_lines_hoses'] },
  { partId: 'PT_0107', key: 'fuel_tank', aliases: [] },
  { partId: 'PT_0108', key: 'engine_block', aliases: [] },
  { partId: 'PT_0109', key: 'engine_oil_pan', aliases: [] },
  { partId: 'PT_0110', key: 'transmission_housing', aliases: ['transmission_case_housing'] },
  ...
  { partId: 'PT_0154', key: 'engine_shield', aliases: ['engine_splash_shield_skid_plate'] },
  { partId: 'PT_0155', key: 'rear_shield', aliases: ['rear_underbody_shield'] },
  { partId: 'PT_0156', key: 'front_shield', aliases: ['front_underbody_shield'] },
  ...
  { partId: 'PT_0203', key: 'trunk_hinges', aliases: ['trunk_hinge'] },
  { partId: 'PT_0204', key: 'trunk_chrome_trim', aliases: ['trunk_moulding_chrome_trim'] },
  { partId: 'PT_0205', key: 'trunk_emblems', aliases: ['rear_emblem_badge'] },
  { partId: 'PT_0206', key: 'trunk_interior_lining', aliases: ['trunk_carpet_trunk_liner'] },
  { partId: 'PT_0207', key: 'trunk_interior_plastic_trim', aliases: ['trunk_interior_trim_panel'] },
  { partId: 'PT_0208', key: 'rear_parcel_shelf', aliases: ['parcel_shelf_rear_tray'] },
  { partId: 'PT_0209', key: 'rear_bumper_lower_valance', aliases: ['rear_bumper_valance_diffuser'] },
  { partId: 'PT_0210', key: 'rear_reflector_right', aliases: [] },
  { partId: 'PT_0211', key: 'rear_reflector_left', aliases: ['rear_reflector'] },
  { partId: 'PT_0212', key: 'trunk_mounted_tail_light', aliases: ['inner_tail_light_trunk_light'] },
  { partId: 'PT_0213', key: 'trunk_spoiler', aliases: [] },
  { partId: 'PT_0214', key: 'rear_bumper_chrome_trim', aliases: ['rear_bumper_moulding'] },
  { partId: 'PT_0215', key: 'exhaust_tip_trim', aliases: ['exhaust_tip'] },
  { partId: 'PT_0216', key: 'trunk_sheet_metal', aliases: ['trunk_lid_tailgate'] },
  { partId: 'PT_0217', key: 'roof_trim_right', aliases: ['roof_drip_moulding_right'] },
  { partId: 'PT_0218', key: 'roof_trim_left', aliases: ['roof_drip_moulding_left'] },
  { partId: 'PT_0219', key: 'front_bumper_lower_valance', aliases: ['front_bumper_lip_lower_valance'] },
  { partId: 'PT_0220', key: 'front_bumper_brackets', aliases: ['front_bumper_support_bracket'] },
  { partId: 'PT_0221', key: 'hood_hinges', aliases: ['hood_hinge'] },
  { partId: 'PT_0222', key: 'hood_struts', aliases: ['hood_lift_strut'] },
  { partId: 'PT_0223', key: 'hood_shocks', aliases: ['active_hood_actuator'] },
  { partId: 'PT_0224', key: 'hood_to_fender_rubber_seal', aliases: ['hood_weatherstrip_rubber_seal'] },
  { partId: 'PT_0225', key: 'front_bumper_chrome_trim', aliases: [] },
  { partId: 'PT_0226', key: 'front_bumper_chrome_trim_right', aliases: ['front_bumper_trim_right'] },
  { partId: 'PT_0227', key: 'front_bumper_chrome_trim_left', aliases: ['front_bumper_trim_left'] },
  { partId: 'PT_0228', key: 'rear_license_plate_bracket', aliases: ['license_plate_holder'] },
  { partId: 'PT_0229', key: 'rear_fender_arch_liner_right', aliases: ['rear_fender_liner_right'] },
  { partId: 'PT_0230', key: 'rear_fender_arch_liner_left', aliases: ['rear_fender_liner_left'] },
  { partId: 'PT_0231', key: 'front_bumper_foam', aliases: ['bumper_energy_absorber_foam'] },
  { partId: 'PT_0232', key: 'alternator', aliases: [] },
  { partId: 'PT_0233', key: 'ac_compressor', aliases: ['a_c_compressor'] },
  { partId: 'PT_0234', key: 'ac_pipes_lines', aliases: ['a_c_line_hose'] },
  { partId: 'PT_0235', key: 'radiator_hoses_assembly', aliases: ['radiator_hose_coolant_pipe'] },
  { partId: 'PT_0236', key: 'turbocharger', aliases: [] },
  { partId: 'PT_0237', key: 'battery_tray', aliases: [] },
  { partId: 'PT_0238', key: 'air_filter_box', aliases: ['air_cleaner_assembly_air_filter_box'] },
  { partId: 'PT_0239', key: 'air_intake_hose', aliases: [] },
  { partId: 'PT_0240', key: 'engine_cover', aliases: [] },
  { partId: 'PT_0241', key: 'serpentine_belt', aliases: [] },
  { partId: 'PT_0242', key: 'alternator_belt', aliases: [] },
  { partId: 'PT_0243', key: 'front_right_wheel_hub_bearing', aliases: ['front_wheel_hub_bearing_right'] },
  { partId: 'PT_0244', key: 'front_left_wheel_hub_bearing', aliases: ['front_wheel_hub_bearing_left'] },
  { partId: 'PT_0245', key: 'rear_right_wheel_hub_bearing', aliases: ['rear_wheel_hub_bearing_right'] },
  { partId: 'PT_0246', key: 'rear_left_wheel_hub_bearing', aliases: ['rear_wheel_hub_bearing_left'] },
  { partId: 'PT_0247', key: 'front_subframe_crossmember', aliases: [] },
  { partId: 'PT_0248', key: 'rear_subframe', aliases: ['rear_axle_beam_differential'] },
  { partId: 'PT_0249', key: 'front_right_door_panel_trim', aliases: ['front_right_door_interior_panel'] },
  { partId: 'PT_0250', key: 'front_left_door_panel_trim', aliases: ['front_left_door_interior_panel'] },
  { partId: 'PT_0251', key: 'rear_right_door_panel_trim', aliases: ['rear_right_door_interior_panel'] },
  { partId: 'PT_0252', key: 'rear_left_door_panel_trim', aliases: ['rear_left_door_interior_panel'] },
  { partId: 'PT_0253', key: 'right_seat_upholstery', aliases: ['front_right_seat_upholstery'] },
  { partId: 'PT_0254', key: 'left_seat_upholstery', aliases: ['front_left_seat_upholstery'] },
  { partId: 'PT_0255', key: 'rear_bench_seat_upholstery', aliases: ['rear_bench_seat'] },
  { partId: 'PT_0256', key: 'armrest', aliases: ['center_armrest'] },
  { partId: 'PT_0257', key: 'center_console', aliases: [] },
  { partId: 'PT_0258', key: 'glove_box', aliases: ['glove_compartment'] },
  { partId: 'PT_0259', key: 'interior_rearview_mirror', aliases: ['rearview_mirror'] },
  { partId: 'PT_0260', key: 'front_pillar_trim_right', aliases: ['a_pillar_trim_right'] },
  { partId: 'PT_0261', key: 'rear_pillar_trim_right', aliases: ['c_pillar_trim_right'] },
  { partId: 'PT_0262', key: 'front_pillar_trim_left', aliases: ['a_pillar_trim_left'] },
  { partId: 'PT_0263', key: 'rear_pillar_trim_left', aliases: ['c_pillar_trim_left'] },
  { partId: 'PT_0264', key: 'middle_b_pillar_trim_right', aliases: ['b_pillar_trim_right'] },
  { partId: 'PT_0265', key: 'middle_b_pillar_trim_left', aliases: ['b_pillar_trim_left'] },
  { partId: 'PT_0266', key: 'head_unit_infotainment_screen', aliases: ['infotainment_display_head_unit'] },
  { partId: 'PT_0267', key: 'ac_vent_right', aliases: ['air_conditioning_vent_right'] },
  { partId: 'PT_0268', key: 'ac_vent_left', aliases: ['air_conditioning_vent_left'] },
  { partId: 'PT_0269', key: 'ac_vent_middle_right', aliases: ['center_air_vent_right'] },
  { partId: 'PT_0270', key: 'ac_vent_middle_left', aliases: ['center_air_vent_left'] },
  { partId: 'PT_0271', key: 'ac_vent_rear_right', aliases: ['rear_air_vent_right'] },
  { partId: 'PT_0272', key: 'ac_vent_rear_left', aliases: ['rear_air_vent_left'] },
  { partId: 'PT_0273', key: 'front_left_door_lock_latch', aliases: ['door_lock_latch_front_left'] },
  { partId: 'PT_0274', key: 'front_right_door_lock_latch', aliases: ['door_lock_latch_front_right'] },
  { partId: 'PT_0275', key: 'rear_left_door_lock_latch', aliases: ['door_lock_latch_rear_left'] },
  { partId: 'PT_0276', key: 'rear_right_door_lock_latch', aliases: ['door_lock_latch_rear_right'] },
  { partId: 'PT_0277', key: 'front_right_door_check_strap', aliases: ['door_check_strap_front_right'] },
  { partId: 'PT_0278', key: 'rear_left_door_check_strap', aliases: ['door_check_strap_rear_left'] },
  { partId: 'PT_0279', key: 'front_left_door_check_strap', aliases: ['door_check_strap_front_left'] },
  { partId: 'PT_0280', key: 'rear_right_door_check_strap', aliases: ['door_check_strap_rear_right'] },
  { partId: 'PT_0281', key: 'side_curtain_airbag_strip', aliases: ['curtain_airbag_assembly'] },
  { partId: 'PT_0282', key: 'front_right_window_weatherstrip', aliases: ['window_weatherstrip_seal_front_right'] },
  { partId: 'PT_0283', key: 'front_left_window_weatherstrip', aliases: ['window_weatherstrip_seal_front_left'] },
  { partId: 'PT_0284', key: 'rear_right_window_weatherstrip', aliases: ['window_weatherstrip_seal_rear_right'] },
  { partId: 'PT_0285', key: 'rear_left_window_weatherstrip', aliases: ['window_weatherstrip_seal_rear_left'] },
  { partId: 'PT_0286', key: 'right_mirror_cover', aliases: ['side_mirror_cap_right'] },
  { partId: 'PT_0287', key: 'left_mirror_cover', aliases: ['side_mirror_cap_left'] },
  { partId: 'PT_0288', key: 'right_mirror_turn_signal', aliases: ['side_mirror_turn_signal_light_right'] },
  { partId: 'PT_0289', key: 'left_mirror_turn_signal', aliases: ['side_mirror_turn_signal_light_left'] },
  { partId: 'PT_0290', key: 'front_right_door_chrome_trim', aliases: ['door_chrome_moulding_front_right'] },
  { partId: 'PT_0291', key: 'rear_right_door_chrome_trim', aliases: ['door_chrome_moulding_rear_right'] },
  { partId: 'PT_0292', key: 'front_left_door_chrome_trim', aliases: ['door_chrome_moulding_front_left'] },
  { partId: 'PT_0293', key: 'rear_left_door_chrome_trim', aliases: ['door_chrome_moulding_rear_left'] },
  { partId: 'PT_0294', key: 'rear_right_quarter_vent_glass', aliases: ['rear_quarter_glass_right'] },
  { partId: 'PT_0295', key: 'rear_left_quarter_vent_glass', aliases: ['rear_quarter_glass_left'] },
  { partId: 'PT_0296', key: 'ambient_air_temperature_sensor', aliases: [] },
  { partId: 'PT_0297', key: 'oxygen_o2_sensor', aliases: [] },
  { partId: 'PT_0298', key: 'thermostat_sensor', aliases: ['coolant_temperature_sensor'] },
  { partId: 'PT_0299', key: 'rain_sensor', aliases: ['rain_light_sensor'] },
  { partId: 'PT_0300', key: 'transmission_input_speed_sensor', aliases: [] },
  { partId: 'PT_0301', key: 'transmission_output_speed_sensor', aliases: [] },
  { partId: 'PT_0302', key: 'front_right_wheel_speed_sensor_abs', aliases: ['abs_wheel_speed_sensor_front_right'] },
  { partId: 'PT_0303', key: 'front_left_wheel_speed_sensor_abs', aliases: ['abs_wheel_speed_sensor_front_left'] },
  { partId: 'PT_0304', key: 'rear_right_wheel_speed_sensor_abs', aliases: ['abs_wheel_speed_sensor_rear_right'] },
  { partId: 'PT_0305', key: 'rear_left_wheel_speed_sensor_abs', aliases: ['abs_wheel_speed_sensor_rear_left'] },
  { partId: 'PT_0306', key: 'rear_left_headlight', aliases: [] },
  { partId: 'PT_0307', key: 'rear_right_headlight', aliases: [] },
];
